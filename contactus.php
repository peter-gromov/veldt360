...
<div class="contactus">
    <div class="wc">
        ...
        <div class="row-25-text"style="margin-bottom: 50px;" id="contact_us">CONTACT US</div>
        <div class="contactus-form">
            <div class="contactus-form-label ">E-mail</div>
            <input type="text" class="contactus-form-input mail-email" placeholder="Your E-mail">
            <div class="contactus-form-label">Name</div>
            <input type="text" class="contactus-form-input  mail-name" placeholder="Your Name">
            ...
            <div style="text-align: right"> <a href="#" class="vbutton js-send black">SEND</a></div>
        </div>
       ...
       function initMap() {
        ...
        <div class="mapblocks">
            <div class="mapblocks-mapblock">
                ...
                <div class="mapblocks-mapblock-col mapblocks-mapblock-col-2">
                    <div class="mapblocks-mapblock-col-info">
                        <div class="mapblocks-mapblock-col-info-title">HONG KONG</div>
            ...
            <div class="mapblocks-mapblock">
                ...
                <div class="mapblocks-mapblock-col mapblocks-mapblock-col-2">
                    <div class="mapblocks-mapblock-col-info">
                        <div class="mapblocks-mapblock-col-info-title">SAINT-PETERSBURG</div>
                        <div class="mapblocks-mapblock-col-info-blocks">
                            <div class="mapblocks-mapblock-col-info-blocks-block">
                                <div class="mapblocks-mapblock-col-info-blocks-block-icon"><img src="icon_location.png"></div>
